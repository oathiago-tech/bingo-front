    ...
    return (
        <div className="min-h-screen bg-slate-950 p-10 text-white font-sans">
            ...
            {selectedSheet && (
                ...
                >
                    <div
                        className="relative max-w-lg bg-white p-4 rounded-2xl shadow-2xl"
                ...
                <div className="bg-slate-900/40 rounded-[2rem] border border-slate-800/50 p-6 flex flex-col h-[700px]">
                    ...
                    <div className="flex-1 space-y-4 overflow-y-auto pr-2 custom-scrollbar">
                        {sheets.length > 0 ? sheets.map((s, i) => (
                            <div
                                key={i}
                                className="bg-slate-900 border border-slate-700 p-6 rounded-3xl flex justify-between items-center hover:border-yellow-500/50 transition-colors group cursor-pointer"
                            ...
                            >
                                ...
                                <div className="flex items-center gap-3">
                                    <div className="text-slate-700 font-bold italic text-xs uppercase tracking-tighter group-hover:text-slate-500 transition-colors">Visualizar</div>
                                    <div className="bg-slate-800 p-3 rounded-xl group-hover:bg-yellow-500 group-hover:text-black transition-all">
                                        👁️
                                    </div>
                                </div>
                            </div>
